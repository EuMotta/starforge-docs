...
- **Accessible**: Built with headless primitives (Radix UI or Base UI), ensuring compliance with ARIA standards.
...
- [Explore Components](/docs/basic/typography)
...
<Callout type="info">
  ...
  installing now in [Installation](/docs/installation).{' '}
</Callout>
