...
export interface CustomSelect1Props
  extends Omit<
...
interface CustomSelect1ContentProps {
  image: string;
  name: string;
  role: string;
  status: string;
...
const CustomSelect1Content = ({
  image,
  name,
  role,
  status,
  email
}: CustomSelect1ContentProps) => {
...
CustomSelect1.displayName = 'CustomSelect1';
